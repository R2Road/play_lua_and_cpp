...
namespace step
{
	void PCall_03()
	{
		...
		if( !test_lua_helper::LuaErrorCheck( lua_state_obj, luaL_dofile( lua_state_obj, "resources/step_PCall_03.lua" ) ) )
		{
			return;
		}
		...
		// Test x 0
		//
		if( test_lua_helper::LuaErrorCheck( lua_state_obj, lua_pcall( lua_state_obj, 0, 1, 0 ) ) )
		{
			//
			// Check Stack 1
			//
