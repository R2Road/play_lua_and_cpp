...
namespace step
{
	void PCall_02()
	{
		...
		if( !test_lua_helper::LuaErrorCheck( lua_state_obj, luaL_dofile( lua_state_obj, "resources/step_PCall_02.lua" ), "luaL_dofile" ) )
		{
			return;
		}
		...
		//
		{
			...
			if( test_lua_helper::LuaErrorCheck( lua_state_obj, lua_pcall( lua_state_obj, 1, 1, 0 ), "lua_pcall" ) )
			{
